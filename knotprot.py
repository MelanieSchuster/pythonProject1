...
def get_proteins(search_string=SEARCH_STRING):
    ...
    return proteins
# decode the web page and split the lines
# take the first two values and insert them into a tuple
